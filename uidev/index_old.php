                    ...
                    <div class="profile-text padding-right-yes">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-grey">
                                    I currently work as a consultant for different clients and projects where I spend most of my time developing and working on awesome projects.
                                </p>
                    ...
                    <div class="contact-details padding-right-yes">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-7">
                                <a class="btn btn-lg btn-custom downloadResumeAnchor btn-disabled" disabled target="_self">
        ...
        <div class="row">
            <div class="col-md-12">
             ...
             <!--    <ul class="list-inline social-icons">
                    <li>
                        <div class="item">
                            <a href="fbUrl" target="#"><i class="fa fa-facebook"></i></a>
                        </div>
                    </li>

                    <li>
                        <div class="item">
                            <a href="linkedInUrl" target="#"><i class="fa fa-linkedin"></i></a>
                        </div>
                    </li>

                    <li>
                        <div class="item">
                            <a href="gitHubLink" target="#"><i class="fa fa-github"></i></a>
                        </div>
                    </li>

                    <li>
                        <div class="item">
                            <a href="googlePlusUrl" target="#"><i class="fa fa-google-plus"></i></a>
                        </div>
                    </li>
                </ul> -->
            </div>
